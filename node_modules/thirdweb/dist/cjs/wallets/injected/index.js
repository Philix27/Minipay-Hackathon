...
exports.autoConnectInjectedWallet = exports.connectInjectedWallet = void 0;
...
async function connectInjectedWallet(id, options, emitter) {
    ...
    let connectedChain = (0, utils_js_1.defineChain)(chainId);
 ...
 * @internal
 */
async function autoConnectInjectedWallet(id, emitter) {
    const provider = getInjectedProvider(id);
    // connected accounts
    const addresses = await provider.request({
        method: "eth_accounts",
    ...
    const chainId = await provider
        .request({ method: "eth_chainId" })
        .then(normalizeChainId_js_1.normalizeChainId);
    const connectedChain = (0, utils_js_1.defineChain)(chainId);
    return onConnect(provider, address, connectedChain, emitter);
}
