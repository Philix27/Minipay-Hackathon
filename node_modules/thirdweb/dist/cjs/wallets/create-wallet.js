        ...
        default: {
            ...
            const wallet = {
                ...
                autoConnect: async (options) => {
                    ...
                    if (id !== "walletConnect" && (0, mipdStore_js_1.injectedProvider)(id)) {
...
function inAppWallet(createOptions) {
    ...
    return {
        ...
        autoConnect: async (options) => {
            ...
            const [connectedAccount, connectedChain] = await autoConnectInAppWallet(options);
            // set the states
            account = connectedAccount;
            chain = connectedChain;
            (0, track_js_1.trackConnect)({
        ...
        connect: async (options) => {
            ...
            const [connectedAccount, connectedChain] = await connectInAppWallet(options);
            // set the states
            account = connectedAccount;
            chain = connectedChain;
            (0, track_js_1.trackConnect)({
