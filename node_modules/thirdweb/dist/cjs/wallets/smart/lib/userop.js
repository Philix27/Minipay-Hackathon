...
exports.signUserOp = exports.createUnsignedUserOp = void 0;
...
async function createUnsignedUserOp(args) {
    ...
    if ((0, fetch_js_1.isThirdwebUrl)(bundlerUrl)) {
        ...
        if (!maxFeePerGas || !maxPriorityFeePerGas) {
            const feeData = await (0, fee_data_js_1.getDefaultGasOverrides)(factoryContract.client, factoryContract.chain);
    ...
    const partialOp = {
        ...
        initCode,
        callData,
        maxFeePerGas: (await (0, resolve_promised_value_js_1.resolvePromisedValue)(maxFeePerGas)) ?? 0n,
        maxPriorityFeePerGas: (await (0, resolve_promised_value_js_1.resolvePromisedValue)(maxPriorityFeePerGas)) ?? 0n,
        callGasLimit: 0n,
...
async function signUserOp(args) {
    ...
    const userOpHash = getUserOpHash({
        userOp,
        entryPoint: options.overrides?.entrypointAddress || constants_js_1.ENTRYPOINT_ADDRESS,
