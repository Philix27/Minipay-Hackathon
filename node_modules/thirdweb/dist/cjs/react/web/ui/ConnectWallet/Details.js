...
const pendingSwapTx_js_1 = require("./screens/Buy/swap/pendingSwapTx.js");
const SwapScreen_js_1 = require("./screens/Buy/SwapScreen.js");
const SwapTransactionsScreen_js_1 = require("./screens/SwapTransactionsScreen.js");
...
const index_js_2 = require("../../../../wallets/in-app/core/authentication/index.js");
...
const ConnectedWalletDetails = (props) => {
    const { connectLocale: locale, client } = (0, useWalletConnectionCtx_js_1.useWalletConnectionCtx)();
    ...
    const swapTxs = (0, react_1.useSyncExternalStore)(pendingSwapTx_js_1.swapTransactionsStore.subscribe, pendingSwapTx_js_1.swapTransactionsStore.getValue);
    ...
    // }
    const trigger = props.detailsButton?.render ? ((0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)(props.detailsButton.render, {}) })) : ((0, jsx_runtime_1.jsxs)(WalletInfoButton, { type: "button", className: `${TW_CONNECTED_WALLET} ${props.detailsButton?.className || ""}`, style: props.detailsButton?.style, "data-test": "connected-wallet-details", children: [activeWallet?.id && ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { size: index_js_1.iconSize.lg, id: activeWallet.id })), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "xxs", children: [addressOrENS ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", color: "primaryText", weight: 500, className: `${TW_CONNECTED_WALLET}__address`, children: addressOrENS })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_1.fontSize.sm, width: "88px" })), balanceQuery.data ? ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { className: `${TW_CONNECTED_WALLET}__balance`, size: "xs", weight: 500, children: [Number(balanceQuery.data.displayValue).toFixed(3), " ", balanceQuery.data.symbol] })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_1.fontSize.xs, width: "82px" }))] })] }));
    const networkSwitcherButton = ((0, jsx_runtime_1.jsxs)(MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
            setScreen("network-switcher");
                    ...
                    alignItems: "center",
                    position: "relative",
                }, children: chainQuery.data ? ((0, jsx_runtime_1.jsx)(ChainIcon_js_1.ChainIcon, { chain: chainQuery.data, size: index_js_1.iconSize.md, active: true })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_1.iconSize.md, width: index_js_1.iconSize.md })) }), chainQuery.isLoading ? ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "16px", width: "200px" })) : ((0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", multiline: true, children: chainQuery.data?.name || `Unknown chain #${walletChain?.id}` })), (0, jsx_runtime_1.jsx)(StyledChevronRightIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm, style: {
                    flexShrink: 0,
                    marginLeft: "auto",
                } })] }));
    let content = ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", flex: "column", center: "x", children: [activeWallet?.id && ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { id: activeWallet.id, size: index_js_1.iconSize.xxl })), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsxs)("div", { style: {
                            display: "flex",
                            ...
                            gap: "1px",
                                    ...
                                    fontSize: index_js_1.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.TextAlignJustifyIcon, { width: index_js_1.iconSize.md, height: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "xs", center: "y", children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: locale.transactions }), pendingSwapTxs && pendingSwapTxs.length > 0 && ((0, jsx_runtime_1.jsx)(BadgeCount, { children: pendingSwapTxs.length }))] })] }), (props.detailsModal?.showTestnetFaucet ?? false) &&
    ...
    if (screen === "pending-tx") {
        content = ((0, jsx_runtime_1.jsx)(SwapTransactionsScreen_js_1.SwapTransactionsScreen, { onBack: () => setScreen("main"), client: client }));
    }
    ...
    // swap tokens
        ...
        content = ((0, jsx_runtime_1.jsx)(SwapScreen_js_1.SwapScreen, { client: client, onBack: () => setScreen("main"), supportedTokens: props.supportedTokens, onViewPendingTx: () => setScreen("pending-tx") }));
    }
...
const BadgeCount = /* @__PURE__ */ (0, elements_js_1.StyledDiv)(() => {
    const theme = (0, CustomThemeProvider_js_1.useCustomTheme)();
    return {
...
function ConnectedToSmartWallet() {
    ...
    const { client } = (0, useWalletConnectionCtx_js_1.useWalletConnectionCtx)();
    ...
    const content = ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "xxs", center: "both", children: [(0, jsx_runtime_1.jsx)(ActiveDot, {}), locale.connectedToSmartWallet] }));
    if (chain && activeAccount && isSmartWallet) {
        return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [isSmartWalletDeployed ? ((0, jsx_runtime_1.jsx)(text_js_1.Link, { color: "secondaryText", hoverColor: "primaryText", href: `https://thirdweb.com/${chain.id}/${activeAccount.address}/account`, target: "_blank", size: "sm", children: content })) : ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { size: "sm", children: [" ", content] })), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" })] }));
    }
    return null;
}
function InAppWalletEmail() {
    const { client } = (0, useWalletConnectionCtx_js_1.useWalletConnectionCtx)();
    const emailQuery = (0, react_query_1.useQuery)({
        queryKey: ["in-app-wallet-user", client],
        queryFn: async () => {
            const data = await (0, index_js_2.getUserEmail)({
                client: client,
            });
            return data || null;
        },
    ...
    if (emailQuery.data) {
        return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "x", style: {
            ...
            }, children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", children: emailQuery.data }) }));
    }
    return null;
}
