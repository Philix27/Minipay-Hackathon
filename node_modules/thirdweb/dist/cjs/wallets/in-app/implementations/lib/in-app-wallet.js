...
const in_app_wallet_js_1 = require("./core/in-app-wallet.js");
/**
 * @internal
 */
class InAppWalletSdk {
    ...
    constructor({ client, onAuthSuccess }) {
        ...
        const baseUrl = `https://${(0, domains_js_1.getThirdwebDomains)().inAppWallet}`;
        this.client = client;
        this.querier = new InAppWalletIframeCommunicator_js_1.InAppWalletIframeCommunicator({
            clientId: client.clientId,
            baseUrl,
        });
        this.wallet = new in_app_wallet_js_1.InAppWallet({
            client,
...
exports.InAppWalletSdk = InAppWalletSdk;
