...
exports.autoConnectCoinbaseWalletSDK = exports.connectCoinbaseWalletSDK = void 0;
...
async function initProvider(options) {
    ...
    const chain = options?.chain || ethereum_js_1.ethereum;
 ...
 * @internal
 */
async function connectCoinbaseWalletSDK(options, emitter) {
    ...
    let chain = (0, utils_js_1.defineChain)(chainId);
 ...
 * @internal
 */
async function autoConnectCoinbaseWalletSDK(options, emitter) {
    const provider = await initProvider(options);
    // connected accounts
    ...
    const chainId = (0, normalizeChainId_js_1.normalizeChainId)(connectedChainId);
    const chain = (0, utils_js_1.defineChain)(chainId);
    return onConnect(address, chain, provider, emitter);
}
