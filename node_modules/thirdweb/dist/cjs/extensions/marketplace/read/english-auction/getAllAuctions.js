...
exports.getAllAuctions = void 0;
const eth_getBlockByNumber_js_1 = require("../../../../rpc/actions/eth_getBlockByNumber.js");
const rpc_js_1 = require("../../../../rpc/rpc.js");
const getAllAuctions_js_1 = require("../../__generated__/IEnglishAuctions/read/getAllAuctions.js");
...
async function getAllAuctions(options) {
    ...
    const [rawAuctions, latestBlock] = await Promise.all([
        (0, utils_js_1.getAllInBatches)((startId, endId) => (0, getAllAuctions_js_1.getAllAuctions)({ contract: options.contract, startId, endId }), {
            start,
            end,
    ...
    return await Promise.all(rawAuctions.map((rawAuction) => (0, utils_js_1.mapEnglishAuction)({
