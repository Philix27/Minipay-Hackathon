        ...
        wallet
            ...
            walletConnect: {
                ...
                onDisplayUri(uri) {
                    ...
                    if (isMobile()) {
                        if (isAndroid()) {
                            openWindow(formatWalletConnectUrl(platformUris.android, uri).redirect);
                        }
                        else if (isIOS()) {
                            openWindow(formatWalletConnectUrl(platformUris.ios, uri).redirect);
                        }
                        else {
                            openWindow(formatWalletConnectUrl(platformUris.other, uri).redirect);
                        }
                    }
                },
...
export const WalletConnectStandaloneConnection = (props) => {
    ...
    return (_jsx(ScanScreen, { qrScanInstruction: locale.scanScreen.instruction, onBack: onBack, qrCodeUri: qrCodeUri, walletName: walletInfo.name, walletId: wallet.id, getStartedLink: locale.getStartedLink }));
};
