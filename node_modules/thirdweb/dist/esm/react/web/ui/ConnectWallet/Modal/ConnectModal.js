...
import { ModalConfigCtx, useIsWalletModalOpen, useSetIsWalletModalOpen, } from "../../../providers/wallet-ui-states-provider.js";
...
const ConnectModal = () => {
    ...
    return (_jsx(CustomThemeProvider, { theme: theme, children: _jsx(Modal, { hide: hideModal, size: modalSize, open: isWalletModalOpen, setOpen: (value) => {
                if (hideModal) {
                    return;
                }
            ...
            }, children: _jsx(ConnectModalContent, { screenSetup: screenSetup, setModalVisibility: setModalVisibility, isOpen: isWalletModalOpen, onClose: closeModal }) }) }));
};
