...
export const WalletSelector = (props) => {
    ...
    return (_jsxs(Container, { scrollY: true, flex: "column", animate: "fadein", fullHeight: true, style: {
        ...
        }, children: [!modalConfig.isEmbed && (_jsx(Container, { p: "lg", style: {
                    paddingBottom: spacing.md,
...
const WalletSelection = (props) => {
    ...
    return (_jsxs(WalletList, { style: {
            minHeight: "100%",
                ...
                return (_jsx("li", { children: wallet.id === "inApp" && modalSize === "compact" ? (_jsx(Suspense, { fallback: _jsx(LoadingScreen, { height: "195px" }), children: _jsx(InAppWalletSelectionUI, { done: () => props.done(wallet), select: () => props.selectWallet(wallet), wallet: wallet, goBack: props.goBack }) })) : (_jsx(WalletEntryButton, { walletId: wallet.id, selectWallet: () => {
                            props.selectWallet(wallet);
                        } })) }, wallet.id));
