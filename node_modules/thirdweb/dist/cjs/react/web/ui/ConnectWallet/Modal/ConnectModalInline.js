...
const ConnectEmbed_js_1 = require("./ConnectEmbed.js");
...
const ConnectModalInline = (props) => {
    const walletConfigs = (0, useWalletConnectionCtx_js_1.useWalletConnectionCtx)().wallets;
    const modalSize = !(0, canFitWideModal_js_1.canFitWideModal)() || walletConfigs.length === 1
        ? "compact"
        : props.modalSize;
    const ctxTheme = (0, CustomThemeProvider_js_1.useCustomTheme)();
    ...
    return ((0, jsx_runtime_1.jsx)(wallet_ui_states_provider_js_1.WalletUIStatesProvider, { ...walletUIStatesProps, children: (0, jsx_runtime_1.jsxs)(CustomThemeProvider_js_1.CustomThemeProvider, { theme: walletUIStatesProps.theme, children: [(0, jsx_runtime_1.jsx)(ConnectModalInlineContent, { className: props.className, modalSize: modalSize }), (0, jsx_runtime_1.jsx)(ConnectEmbed_js_1.SyncedWalletUIStates, { ...walletUIStatesProps })] }) }));
};
