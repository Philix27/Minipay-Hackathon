import { type GetContractReturnType, type PublicClient, type Chain as ViemChain, type WalletClient, type TransactionSerializableEIP1559 } from "viem";
...
declare function toViemContract<const TAbi extends Abi>(options: {
...
declare function toViemWalletClient(options: ToViemWalletClientOptions): {
    account: {
        address: string;
        type: "json-rpc";
    };
    ...
    deployContract: <const abi extends readonly unknown[] | Abi, chainOverride extends ViemChain | undefined>(args: import("viem").DeployContractParameters<abi, ViemChain, {
        address: string;
        type: "json-rpc";
    ...
    prepareTransactionRequest: <const TRequest extends import("viem").PrepareTransactionRequestRequest<ViemChain, TChainOverride>, TChainOverride extends ViemChain | undefined = undefined, TAccountOverride extends string | import("viem").Account | undefined = undefined>(args: import("viem").PrepareTransactionRequestParameters<ViemChain, {
        address: string;
        type: "json-rpc";
        ...
        accessList?: import("viem").AccessList | undefined;
    })) | import("viem").Opaque<TransactionSerializableEIP1559, TRequest> | import("viem").Opaque<import("viem").TransactionRequestEIP1559, TRequest> ? "eip1559" : never) | (TRequest extends ({
        accessList?: import("viem").AccessList | undefined;
        blobs?: undefined;
        blobVersionedHashes?: undefined;
        gasPrice?: bigint | undefined;
    ...
    sendTransaction: <const TRequest_1 extends import("viem").SendTransactionRequest<ViemChain, TChainOverride_1>, TChainOverride_1 extends ViemChain | undefined = undefined>(args: import("viem").SendTransactionParameters<ViemChain, {
        address: string;
        type: "json-rpc";
    ...
    signTransaction: <TChainOverride_2 extends ViemChain | undefined>(args: import("viem").SignTransactionParameters<ViemChain, {
        address: string;
        type: "json-rpc";
    ...
    extend: <const client extends {
        ...
        type?: undefined;
        uid?: undefined;
    } & import("viem").ExactPartial<Pick<import("viem").PublicActions<import("viem").CustomTransport, ViemChain, {
        address: string;
        type: "json-rpc";
    }>, "estimateGas" | "readContract" | "getTransactionCount" | "call" | "getChainId" | "getGasPrice" | "createContractEventFilter" | "createEventFilter" | "estimateContractGas" | "getBlock" | "getBlockNumber" | "getContractEvents" | "getEnsText" | "getFilterChanges" | "getLogs" | "getTransaction" | "getTransactionReceipt" | "prepareTransactionRequest" | "sendRawTransaction" | "simulateContract" | "uninstallFilter" | "watchBlockNumber" | "watchContractEvent"> & Pick<import("viem").WalletActions<ViemChain, {
        address: string;
        type: "json-rpc";
    }>, "sendTransaction" | "writeContract">>>(fn: (client: import("viem").Client<import("viem").CustomTransport, ViemChain, {
        address: string;
        type: "json-rpc";
    }, import("viem").WalletRpcSchema, import("viem").WalletActions<ViemChain, {
        address: string;
        type: "json-rpc";
    }>>) => client) => import("viem").Client<import("viem").CustomTransport, ViemChain, {
        address: string;
        type: "json-rpc";
    }, import("viem").WalletRpcSchema, { [K_1 in keyof client]: client[K_1]; } & import("viem").WalletActions<ViemChain, {
        address: string;
        type: "json-rpc";
    }>>;
};
