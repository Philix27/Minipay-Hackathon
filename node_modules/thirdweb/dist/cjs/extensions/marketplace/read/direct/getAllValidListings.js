...
exports.getAllValidListings = void 0;
const eth_getBlockByNumber_js_1 = require("../../../../rpc/actions/eth_getBlockByNumber.js");
const rpc_js_1 = require("../../../../rpc/rpc.js");
const getAllValidListings_js_1 = require("../../__generated__/IDirectListings/read/getAllValidListings.js");
...
async function getAllValidListings(options) {
    ...
    const [rawListings, latestBlock] = await Promise.all([
        (0, utils_js_1.getAllInBatches)((startId, endId) => (0, getAllValidListings_js_1.getAllValidListings)({
    ...
    return await Promise.all(rawListings.map((rawListing) => (0, utils_js_1.mapDirectListing)({
        contract: options.contract,
        latestBlock,
        rawListing,
    })));
