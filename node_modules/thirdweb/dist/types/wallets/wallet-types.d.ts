...
import type { InAppWalletAuth, InAppWalletAutoConnectOptions, InAppWalletConnectionOptions } from "./in-app/core/wallet/index.js";
import type { CoinbaseSDKWalletConnectionOptions } from "./coinbase/coinbaseSDKWallet.js";
import type { ThirdwebClient } from "../client/client.js";
export type WalletId = "walletConnect" | "inApp" | "smart" | WCSupportedWalletIds | InjectedSupportedWalletIds;
 ...
 * ````
 */
export type WalletConnectionOption<T extends WalletId> = T extends "walletConnect" ? StandaloneWCConnectOptions : T extends "smart" ? SmartWalletConnectionOptions : T extends "inApp" ? InAppWalletConnectionOptions : T extends "com.coinbase.wallet" ? InjectedConnectOptions | CoinbaseSDKWalletConnectionOptions : T extends InjectedSupportedWalletIds & WCSupportedWalletIds ? InjectedConnectOptions | WCConnectOptions : T extends InjectedSupportedWalletIds ? InjectedConnectOptions : WCConnectOptions;
/**
 ...
 * ````
 */
export type WalletAutoConnectionOption<T extends WalletId> = T extends "walletConnect" ? WCAutoConnectOptions : T extends "smart" ? SmartWalletConnectionOptions : T extends "inApp" ? InAppWalletAutoConnectOptions : T extends "com.coinbase.wallet" ? InjectedConnectOptions | CoinbaseSDKWalletConnectionOptions : T extends InjectedSupportedWalletIds & WCSupportedWalletIds ? InjectedConnectOptions | WCAutoConnectOptions : T extends InjectedSupportedWalletIds ? InjectedConnectOptions : WCAutoConnectOptions;
/**
 ...
 * ````
 */
export type WalletCreationOptions<T extends WalletId> = T extends "smart" ? SmartWalletOptions : T extends "inApp" ? InAppWalletCreationOptions : undefined;
/**
