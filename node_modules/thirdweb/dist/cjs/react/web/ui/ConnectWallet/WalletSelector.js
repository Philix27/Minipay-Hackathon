...
const twIcon_js_1 = require("./icons/twIcon.js");
...
const WalletSelector = (props) => {
    ...
    const recommendedWallets = (0, useWalletConnectionCtx_js_1.useWalletConnectionCtx)().recommendedWallets;
    ...
    const twTitle = ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { gap: "xxs", center: "y", flex: "row", children: [modalConfig.titleIconUrl === undefined ? ((0, jsx_runtime_1.jsx)(text_js_1.Link, { color: "primaryText", hoverColor: "accentText", target: "_blank", href: "https://thirdweb.com/connect?utm_source=cw", style: {
                    display: "flex",
                    alignItems: "center",
                }, onClick: (e) => {
                ...
                }, children: (0, jsx_runtime_1.jsx)(twIcon_js_1.TWIcon, { size: index_js_1.iconSize.md }) })) : modalConfig.titleIconUrl === "" ? null : ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: modalConfig.titleIconUrl, width: index_js_1.iconSize.md, height: index_js_1.iconSize.md })), (0, jsx_runtime_1.jsxs)(modalElements_js_1.ModalTitle, { children: [" ", props.title, " "] })] }));
    ...
    const connectAWallet = ((0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { fullWidth: true, variant: "outline", style: {
            display: "flex",
        ...
        }, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xxs", children: eoaWallets.slice(0, 2).map((w) => ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { id: w.id, size: index_js_1.iconSize.sm }, w.id))) }), locale.connectAWallet] }));
    ...
    const tos = termsOfServiceUrl || privacyPolicyUrl ? ((0, jsx_runtime_1.jsx)(TOS_js_1.TOS, { termsOfServiceUrl: termsOfServiceUrl, privacyPolicyUrl: privacyPolicyUrl })) : undefined;
    let topSection;
    let bottomSection;
    // wide modal
    if (!isCompact) {
    ...
    // compact
        ...
        if (socialWallets.length === 0) {
            topSection = ((0, jsx_runtime_1.jsx)(WalletSelection, { wallets: nonLocalWalletConfigs, selectWallet: handleSelect, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll }));
            bottomSection = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", p: "lg", gap: "lg", children: [newToWallets, continueAsGuest] }), !continueAsGuest && (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), tos && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "md", style: {
            ...
            if (!isWalletGroupExpanded) {
                ...
                // social login + eoa wallets
                    ...
                    if (eoaWallets.length > 1) {
                        bottomSection = ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "sm", children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", flex: "column", gap: "md", children: [connectAWallet, continueAsGuest] }), tos ? ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { p: "md", children: [" ", tos, " "] })) : ((0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }))] }));
                    }
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { scrollY: true, flex: "column", animate: "fadein", fullHeight: true, style: {
        ...
        }, children: [!modalConfig.isEmbed && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", style: {
                    paddingBottom: index_js_1.spacing.md,
                }, children: isWalletGroupExpanded ? ((0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: twTitle, onBack: () => {
                        setIsWalletGroupExpanded(false);
                    } })) : (twTitle) })), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { expand: true, scrollY: true, px: "md", style: modalConfig.isEmbed
                    ? {
                        paddingTop: index_js_1.spacing.lg,
                    }
                    : {
                        paddingTop: "2px",
                    }, children: [modalConfig.isEmbed && isWalletGroupExpanded && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "y", style: {
                            ...
                            }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.ChevronLeftIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm }), locale.goBackButton] }) })), topSection] }), bottomSection, isCompact && modalConfig.showThirdwebBranding !== false && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { py: "md", children: (0, jsx_runtime_1.jsx)(PoweredByTW_js_1.PoweredByThirdweb, {}) }))] }));
};
exports.WalletSelector = WalletSelector;
let _installedWallets = [];
function getInstalledWallets() {
    if (_installedWallets.length === 0) {
        const providers = (0, mipdStore_js_1.getMIPDStore)().getProviders();
...
const WalletSelection = (props) => {
    const { recommendedWallets, showAllWallets } = (0, useWalletConnectionCtx_js_1.useWalletConnectionCtx)();
    ...
    return ((0, jsx_runtime_1.jsxs)(WalletList, { style: {
            minHeight: "100%",
                ...
                return ((0, jsx_runtime_1.jsx)("li", { children: wallet.id === "inApp" && modalSize === "compact" ? ((0, jsx_runtime_1.jsx)(react_1.Suspense, { fallback: (0, jsx_runtime_1.jsx)(LoadingScreen_js_1.LoadingScreen, { height: "195px" }), children: (0, jsx_runtime_1.jsx)(InAppWalletSelectionUI, { done: () => props.done(wallet), select: () => props.selectWallet(wallet), wallet: wallet, goBack: props.goBack }) })) : ((0, jsx_runtime_1.jsx)(WalletEntryButton_js_1.WalletEntryButton, { walletId: wallet.id, selectWallet: () => {
                            props.selectWallet(wallet);
                        } })) }, wallet.id));
